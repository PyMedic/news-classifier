...
def startup_event():
    ...
    data["logfile"] = open(GLOBAL_CONFIG["service"]["log_destination"], mode='a', encoding='utf-8')
...
def predict(request: PredictRequest):
    ...
    # We need the time it took in milliseconds.
    ...
    to_log = {
        ...
        'latency': str(latency) + " milliseconds"
    }

    log_string = json.dumps(to_log)
    filewrite = data["logfile"].write(log_string)
    data["logfile"].write("\n")
    data["logfile"].flush()
